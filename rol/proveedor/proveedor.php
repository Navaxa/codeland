...
<body>
        ...
        <div class="container">
            ...
            <div class="navbar-collapse" id="second-navbar">
                <ul class="navbar-nav ml-auto">
                    <li class="nav.item activo"><a class="nav-link" href="#">Tablero</a></li>
    ...
    <section style="background: #ededf4; text-align: center;" class="p-5">
        <div class="container">
            <h1>Intereses</h1>
            <p>En esta sección puedes observar lo que necesitan los usuarios.</p>
        </div>
    </section>
    ...
    <section class="container mt-5">
         <!--<div class="interes">
            <div class="row">
                <div class="nombre col-lg-3 col-md-12">
                    <h6>Nombre</h6>
                </div>
                <div class="descripcion col-lg-5 col-md-12">
                    <h6>Descripción</h6>
                </div>  
                <div class="servicio col-lg-3 col-md-12">
                    <h6>Servicios</h6>
                </div>
            </div>
        </div>-->
                ...
                echo '
                    <div class="interes">
                      <div class="row">
                            ...
                            <a href="masinfo.php?cl='.$id_Cliente.'" class="boton negociar col-lg-1 col-md-12"> Negociar</a>
                        </div>
                    </div>
                ';
                    }
