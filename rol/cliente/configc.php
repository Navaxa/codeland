...
<body>
        ...
        <div class="container">
            ...
            <div class="navbar-collapse" id="second-navbar">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav.item"><a class="nav-link" href="solicitudes.php">Solicudes</a></li>
    ...
    <form action="../proveedor/datos_usuario_proveedor.php" name="formulario" method="POST" class="row" enctype="multipart/form-data">
            ...
            <div class="form col-lg-6 col-md-12">
                <h5>Dedicación</h5>
                <input class="cajon" id="nombre_company" type="text" name="dedicacion" placeholder="Ej: Ingeniero en, Asesor de finanzas, Conductor." required="" value="<?php if(isset($dedicacion)){ echo $dedicacion;}else{ echo "";}?>">
            </div>
            <div class="form col-lg-6 col-md-12">
                <h5>Teléfono</h5>
            ...
            <div class="form col-lg-12 col-md-12">
                ...
                <div class="from  col-lg-12 col-md-12">
                    <h5>¿Cómo te encuentro en Facebook?</h5>
                    <input class="cajon" id="site" type="text" name="site" placeholder="URL directo a tu perfil" value="<?php if(isset($facebook)){ echo $facebook;}else{ echo "";}?>">
                </div>
            <div class="form col-lg-12 col-md-12 pt-2">
                <h5>Sobre ti</h5>
                <textarea class="cajon" id="descripcon" cols="50" rows="5" type="Textarea" name="sobre_user" placeholder="Cuentanos de ti, ¿Qué buscas dentro de la plataforma?" required=""><?php if(isset($acerca_de)){ echo $acerca_de;}else{ echo "";} ?></textarea>
            </div>
